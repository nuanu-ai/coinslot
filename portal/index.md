...
Момент, в который покупатель с деньгами расстаётся, у разных товаров разный:
у одних они приходят после того, как вы выдали, у других — сразу при покупке.
Разбор этого и всего остального про деньги — на странице
[«Деньги»](/money).
...
1. Что вы продаёте. Достаточно ссылки на сайт, каталог или документацию —
   ...
   Кабинета на пилоте нет: карточку мы присылаем вам, вы отвечаете «да» или
   говорите, что поправить. Последнее слово остаётся за вами, потому что
...
3. Выдержит ли товар повторную выдачу. Один и тот же заказ может прийти к вам
   ...
   а вот единица со склада или разовый код из ограниченной пачки так не
   переживает. На пилоте мы выставляем товары первого рода; остальные ждут
   механики возврата денег.
...
Продажи можно остановить в любой момент: на пилоте скажите нам, и мы поставим
ваши карточки на паузу. На паузе карточки перестают продаваться, а уже
принятые заказы доигрываются обычным порядком; чтобы открытых заказов не
осталось, нужно уйти совсем.

Если ваша сторона перестала отвечать, продажи останавливаются и без вас — так
же, как по вашей просьбе. Признаки, по которым мы считаем сторону замолчавшей,
мы назовём до пилота; сама остановка описана на странице
...
- Сводка продаж в одном месте. На пилоте её нет: вы смотрите переводы на
  кошелёк и заказы у себя.
...
- Признаки, по которым мы считаем вашу сторону замолчавшей, и порядок
  возврата к продажам.
